  ...
  <div class="max-w-md w-full p-6 bg-white rounded-md shadow-md">
    ...
    <form class="space-y-4">
      <div>
        ...
        <input type="email" id="email" bind:value={email} class="w-full border-gray-300 rounded-md shadow-sm p-2" />
      </div>
      <div>
        <label for="password" class="block mb-1">Password</label>
        <input type="password" id="password" bind:value={password} class="w-full border-gray-300 rounded-md shadow-sm p-2" />
      </div>
